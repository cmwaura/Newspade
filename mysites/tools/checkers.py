...
from  mysites.models import BBCNews, ReutersNews, AljazeeraNews, EconomistNews
...
class ReutersChecker(DjangoChecker):
	...
	def __init__(self, *args, **kwargs):
		...
		self.scheduler_runtime = self.ref_object.checker_runtime
		super(ReutersChecker, self).__init__(self, *args, **kwargs)
...
class AljazeeraChecker(DjangoChecker):
	...
	def __init__(self, *args, **kwargs):
		...
		self.scheduler_runtime = self.ref_object.checker_runtime
		super(AljazeeraChecker, self).__init__(self, *args, **kwargs)

class EconomistChecker(DjangoChecker):
	
	name = 'Economist_Checker'

	def __init__(self, *args, **kwargs):
		self._set_ref_object(EconomistNews, **kwargs)
		self.scraper = self.ref_object.economist.scraper
		self.scheduler_runtime = self.ref_object.checker_runtime
		super(EconomistChecker, self).__init__(self, *args, **kwargs)
